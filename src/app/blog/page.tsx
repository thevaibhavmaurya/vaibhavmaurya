...
export const metadata: Metadata = {
  ...
  description:
    "Technical articles, tutorials, and insights about web development, React, Next.js, TypeScript, and modern software engineering practices by Vaibhav Maurya.",
  keywords: [...seoKeywords.global, ...seoKeywords.blog],
  authors: [
    {
